...
export default class Agendar extends Component {
  ...
  onSubmit(e) {
    ...
    axios
      .post("http://localhost:4000/agendamentos", agendamentoObjeto)
      .then(res => {
        axios
          .post("http://localhost:5000/crawler-scheduler", {
            agendamentoid: res.data["id"],
            link: res.data["link"],
            ecommerce: res.data["ecommerce"]
          })
          .then(res => {
      ...
      <div>
        ...
        <form id="formAgendaCrawler" onSubmit={this.onSubmit}>
          <div class="form-row align-items-center">
            ...
            <div class="col-auto">
              <button type="submit" class="btn btn-primary" id="agendaCrawler">
                Agendar
              </button>
            </div>
          </div>
